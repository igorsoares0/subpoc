...
export function TimelineFilmstrip({
  ...
  return (
    <div ref={containerRef} className="relative w-full" style={{ height: `${FRAME_HEIGHT}px` }}>
      ...
      {/* Indicador de "Optimizing..." quando Canvas está pronto mas filmstrip backend ainda processando */}
      {filmstripState.status === 'canvas-ready' && (
        <div className="absolute top-1 right-1 bg-yellow-500/90 text-black text-[10px] font-medium px-2 py-0.5 rounded flex items-center gap-1">
